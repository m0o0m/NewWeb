...
namespace GL.Data.DAL
{
    public class BaseDataDAL
    {
        ...
        ,sum(ProfitAdd8) ProfitAdd8 ,
          sum(ProfitDel8) ProfitDel8 
        ,sum(ProfitAdd9) ProfitAdd9 ,
          sum(ProfitDel9) ProfitDel9 ,
   sum(ProfitAdd10) ProfitAdd10,
  sum(ProfitDel10) ProfitDel10
        ,sum(ProfitScale) ProfitScale ,sum(ProfitHorse) ProfitHorse ,sum(ProfitZodiac) ProfitZodiac ,sum(ProfitCar) ProfitCar 
         ...
         ,sum(ProfitShuihuZhuan) ProfitShuihuZhuan
         ,sum(ProfitShuiguoji) ProfitShuiguoji
,sum(ProfitSerial) ProfitSerial
        from (
        select ifnull(sum(Texas_LAward_W + Texas_MAward_W + Texas_HAward_W) ,0) ProfitAdd1 
         ...
         ,ifnull(sum(Shuihu_Award_W) ,0) ProfitAdd8 ,ifnull(sum(Shuihu_Award_L) ,0) ProfitDel8 
         ,ifnull(sum(Shuiguoji_Award_W) ,0) ProfitAdd9 ,ifnull(sum(Shuiguoji_Award_L) ,0) ProfitDel9 
  ,ifnull(sum(Serial_Award_W) ,0) ProfitAdd10 ,ifnull(sum(Serial_Award_L) ,0) ProfitDel10 
            ,0 ProfitScale ,0 ProfitHorse ,0 ProfitZodiac ,0 ProfitCar ,0 ProfitHundred ,0 ProfitBaiJiaLe
        ,0 ProfitShuihuZhuan,0 ProfitShuiguoji,0 ProfitSerial
