...
namespace GL.Data.OWeb.Identity
{
    ...
    public class CustomerDbContext : IdentityDbContext<CustomerUser, CustomerRole, string, CustomerUserLogin, CustomerUserRole, CustomerUserClaim>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerRole>().ToTable("CustomerRoles", "GServerInfo");
            modelBuilder.Entity<CustomerUserLogin>().ToTable("CustomerUserLogins", "GServerInfo");
            modelBuilder.Entity<CustomerUserClaim>().ToTable("CustomerUserClaims", "GServerInfo");
            modelBuilder.Entity<CustomerUserRole>().ToTable("CustomerUserRoles", "GServerInfo");
            ...
            //var role = modelBuilder.Entity<CustomerRole>().HasKey(ir => ir.Id).ToTable("CustomerRoles", "GServerInfo");
