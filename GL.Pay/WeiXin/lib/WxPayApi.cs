    ...
    public class WxPayApi
    {
        ...
        */
        ...
        public static WxPayData UnifiedOrder2(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = HttpClientHelper.PostResponse(url, xml);
        ...
        */
        ...
        {
            return GL.Common.Utils.GenerateOutTradeNo(WxPayConfig.MCHID);
        }
        ...
        */
        ...
        {
            return GL.Common.Utils.GenerateTimeStamp();
        }
        ...
        */
        ...
        {
            return GL.Common.Utils.GenerateNonceStr();
        }
    }
}