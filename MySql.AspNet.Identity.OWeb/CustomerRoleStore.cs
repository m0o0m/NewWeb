...
using MySql.AspNet.Identity.OWeb.Repositories;
using System;
...
{
    public class CustomerRoleStore<TRole> : IQueryableRoleStore<TRole>
        where TRole : IdentityRole
    {
        ...
        public CustomerRoleStore(string connectionStringName)
        {
