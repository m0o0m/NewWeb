...
namespace ProtoCmd.BackRecharge {
  ...
  public static partial class BackRecharge {
    ...
    static BackRecharge() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChJCYWNrUmVjaGFyZ2UucHJvdG8SFVByb3RvQ21kLkJhY2tSZWNoYXJnZSKk", 
            "AQoGbm9ybWFsEg4KBnVzZXJJRBgBIAIoDRIMCgRsaXN0GAIgAigJEgwKBHJt", 
            "Yl8YAyACKA0SEAoIZmlyc3RHaWYYBCACKAgSDgoGYmlsbE5vGAUgASgJEhIK", 
            "CnJtYl9hY3R1YWwYBiABKA0SCwoDbnVtGAcgASgNEhIKCnVuaXRfcHJpY2UY", 
            "CCABKA0SFwoPdW5pdF9kaXNjb3VudGVkGAkgASgNIigKCW5vcm1hbFJlcBIO", 
            "CgZ1c2VySUQYASACKA0SCwoDc3VjGAIgAigIKjMKBkJSX0NtZBIMCghCUl9C", 
            "RUdJThALEg0KCUJSX05PUk1BTBANEgwKCEJSX1RPVEFMEBQqTAoJQ2VudGVy", 
            "Q21kEgwKCENTX0JFR0lOEAsSFAoQQ1NfQ09OTkVDVF9FUlJPUhAMEg0KCUNT", 
          "X05PUk1BTBANEgwKCENTX1RPVEFMEGQ="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_ProtoCmd_BackRecharge_normal__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::ProtoCmd.BackRecharge.normal, global::ProtoCmd.BackRecharge.normal.Builder>(internal__static_ProtoCmd_BackRecharge_normal__Descriptor,
                new string[] { "UserID", "List", "Rmb", "FirstGif", "BillNo", "RmbActual", "Num", "UnitPrice", "UnitDiscounted", });
  ...
  public sealed partial class normal : pb::GeneratedMessage<normal, normal.Builder> {
    ...
    private static readonly string[] _normalFieldNames = new string[] { "billNo", "firstGif", "list", "num", "rmb_", "rmb_actual", "unit_discounted", "unit_price", "userID" };
    private static readonly uint[] _normalFieldTags = new uint[] { 42, 32, 18, 56, 24, 48, 72, 64, 8 };
    ...
    public const int UnitDiscountedFieldNumber = 9;
    private bool hasUnitDiscounted;
    private uint unitDiscounted_;
    public bool HasUnitDiscounted {
      get { return hasUnitDiscounted; }
    }
    [global::System.CLSCompliant(false)]
    public uint UnitDiscounted {
      get { return unitDiscounted_; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasUserID) {
        output.WriteUInt32(1, field_names[8], UserID);
      }
      if (hasList) {
        output.WriteString(2, field_names[2], List);
      }
      if (hasRmb) {
        output.WriteUInt32(3, field_names[4], Rmb);
      }
      if (hasFirstGif) {
      ...
      if (hasRmbActual) {
        output.WriteUInt32(6, field_names[5], RmbActual);
      }
      if (hasNum) {
        output.WriteUInt32(7, field_names[3], Num);
      }
      if (hasUnitPrice) {
        output.WriteUInt32(8, field_names[7], UnitPrice);
      }
      if (hasUnitDiscounted) {
        output.WriteUInt32(9, field_names[6], UnitDiscounted);
      }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasNum) {
        size += pb::CodedOutputStream.ComputeUInt32Size(7, Num);
      }
      if (hasUnitPrice) {
        size += pb::CodedOutputStream.ComputeUInt32Size(8, UnitPrice);
      }
      if (hasUnitDiscounted) {
        size += pb::CodedOutputStream.ComputeUInt32Size(9, UnitDiscounted);
      }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<normal, Builder> {
      ...
      public override Builder MergeFrom(normal other) {
        ...
        if (other.HasUnitDiscounted) {
          UnitDiscounted = other.UnitDiscounted;
        }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 64: {
              result.hasUnitPrice = input.ReadUInt32(ref result.unitPrice_);
              break;
            }
            case 72: {
              result.hasUnitDiscounted = input.ReadUInt32(ref result.unitDiscounted_);
              break;
            }
          }
        }
      ...
      [global::System.CLSCompliant(false)]
      public Builder SetUnitPrice(uint value) {
        PrepareBuilder();
      ...
      public bool HasUnitDiscounted {
        get { return result.hasUnitDiscounted; }
      }
      [global::System.CLSCompliant(false)]
      public uint UnitDiscounted {
        get { return result.UnitDiscounted; }
        set { SetUnitDiscounted(value); }
      }
      [global::System.CLSCompliant(false)]
      public Builder SetUnitDiscounted(uint value) {
        PrepareBuilder();
        result.hasUnitDiscounted = true;
        result.unitDiscounted_ = value;
        return this;
      }
      public Builder ClearUnitDiscounted() {
        PrepareBuilder();
        result.hasUnitDiscounted = false;
        result.unitDiscounted_ = 0;
        return this;
      }
    }
    static normal() {
